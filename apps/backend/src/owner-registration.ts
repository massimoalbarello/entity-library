export const OWNER_USER_ID = "entity-library-owner";
export const OWNER_SYNTHETIC_EMAIL =
  "entity-library-owner@entity-library.invalid";
export const OWNER_DISPLAY_NAME = "Entity Library Owner";
...
const ERROR_MESSAGES: Record<OwnerRegistrationErrorCode, string> = {
  owner_already_registered:
    "This Entity Library instance already has an owner.",
